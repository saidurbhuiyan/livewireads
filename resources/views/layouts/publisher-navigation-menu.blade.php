    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center ml-6">
                ...
                <!-- Navigation Links -->
                <div class="ml-3 relative">
                    <x-jet-nav-link class="border-b-0" href="{{ route('admin.dashboard') }}">
                        {{ __('Admin Panel') }}
                    </x-jet-nav-link>
                </div>
                @endrole
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex h-12">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-jet-nav-link href="{{ route('publisher.dashboard') }}" :active="request()->routeIs('publisher.dashboard')">
                    {{ __('Dashboard') }}
                </x-jet-nav-link>
            </div>
            ...
            <!-- Navigation Links -->
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-jet-nav-link href="{{ route('websites') }}" :active="request()->routeIs('websites')">
                    {{ __('Websites') }}
                </x-jet-nav-link>
            </div>
            ...
            <!-- Navigation Links -->
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <x-jet-nav-link href="{{ route('apps') }}" :active="request()->routeIs('apps')">
                    {{ __('Apps') }}
                </x-jet-nav-link>
            </div>
        ...
        <div  class="absolute left-0 -top-[7rem] overflow-auto lg:hidden">
            <div class="relative bg-white w-80 max-w-[calc(100%-3rem)] px-6 pb-6 pt-8 dark:bg-slate-800">
                ...
                <div class="py-1 space-y-1">
                    <x-jet-responsive-nav-link href="{{ route('publisher.dashboard') }}" :active="request()->routeIs('publisher.dashboard')">
                        {{ __('Dashboard') }}
                ...
                <!-- Responsive Navigation Links -->
                <div class="py-1 space-y-1">
                    <x-jet-responsive-nav-link href="{{ route('apps') }}" :active="request()->routeIs('apps')">
                        {{ __('Apps') }}
                    </x-jet-responsive-nav-link>
                </div>
