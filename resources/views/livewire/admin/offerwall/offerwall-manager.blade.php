<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-sm-center text-gray-500 dark:text-gray-300">
        ...
        <tbody>
        @foreach($offerwall_data as $offer)
            <tr class="border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700 text-center">
                ...
                <td class="px-6 py-4 font-medium hover:text-gray-900 focus:text-gray-900 hover:dark:text-gray-100 focus:dark:text-gray-100 whitespace-nowrap">
                ...
                <td class="px-6 py-4">
                    <span class="bg-{{$this->readable_status[$offer->status]['color']}}-500 text-white text-sm font-bold mr-2 px-2.5 py-0.5 rounded">{{$this->readable_status[$offer->status]['text']}}</span>
                </td>
                <td class="p-4">
    ...
    <x-jet-dialog-modal wire:model="confirmingOfferwallDelete">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button class="ml-3" wire:click="deleteOfferwall({{$offerwall_id}})" wire:loading.attr="disabled">
                {{ __('Yes, Delete') }}
            </x-jet-danger-button>
        </x-slot>
    </x-jet-dialog-modal>
