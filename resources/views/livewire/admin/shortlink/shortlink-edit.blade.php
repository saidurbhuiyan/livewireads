<div>
    <x-form-section submit="updateShortLink">
        <x-slot name="title">
            {{ __('Edit Shortlink') }}
        </x-slot>
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <x-jet-input id="display_name" type="text" class="mt-1 block w-full" wire:model.defer="display_name" required />
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <x-jet-input id="api_url" type="text" class="mt-1 block w-full" wire:model.defer="api_url" required />
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <x-jet-input id="api_token" type="text" class="mt-1 block w-full" wire:model.defer="api_token" required />
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <x-jet-input id="count_limit" type="number" class="mt-1 block w-full" wire:model.defer="count_limit" required />
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <x-jet-input id="site_cpm" type="number" step="0.01" class="mt-1 block w-full" wire:model.defer="site_cpm" required />
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <x-jet-input id="actual_cpm" type="number" step="0.01" class="mt-1 block w-full" wire:model.defer="actual_cpm" required />
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <x-jet-input id="time" type="number" class="mt-1 block w-full" wire:model.defer="time" required />
