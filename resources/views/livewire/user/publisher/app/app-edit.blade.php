        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <select name="site_name" id="site_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring focus:ring-indigo-200 focus:border-indigo-300 focus:ring-opacity-50 block w-full px-3 py-3 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-500 dark:text-gray-200 mt-1" wire:model.defer="site_name" autocomplete="site_name" required>
                    <option value="{{ $site_name }}" selected>{{ $domain_name }}</option>
                </select>
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                <label for="default-toggle" class="relative inline-flex items-center mb-4 cursor-pointer">
                    <input type="checkbox" name="is_allow_decimal" value="" id="default-toggle" class="sr-only peer" wire:model.defer="is_allow_decimal" autocomplete="is_allow_decimal">
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <small class="text-gray-800 dark:text-gray-400">This is the URL we will send a GET request to when a user withdraws earnings to your website. If your postback does not return an HTTP 200 OK success status, we will consider it a failure and send you a notification.</small>
            </div>
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <div class="mb-2"><span class="text-red-600 font-bold">{hash}</span><span class="text-gray-800 dark:text-gray-400 font-medium text-sm ml-3">(optional) The SHA256 security hash.</span></div>
                </p>
            </div>
            ...
            <div class="col-span-6 sm:col-span-4 mb-2">
                ...
                <div class="mb-2"><span class="text-green-600 font-bold">1. Server IP Whitelisting</span><span class="text-grey-800 dark:text-gray-400 text-sm">You can whitelist requests from this IP only <span class="font-bold">xxxxxxxxxx</span></span></div>
                <div class="mb-2"><span class="text-green-600 font-bold">2. Postback Hash</span><span class="text-grey-800 dark:text-gray-400 text-sm">We will send back the following hashed value using the {hash} macro. <br> hash("sha256", userID . revenue . SecretKey) <br> Your Secret Key: <span class="font-bold">{{ $secret_key }}</span></span></div>
            </div>
        </x-slot>
